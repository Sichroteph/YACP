...
The same demo opens **Books Finished** directly for a deterministic automated
capture with year-bearing start and finish dates that does not depend on the
simulator's saved button mapping:
