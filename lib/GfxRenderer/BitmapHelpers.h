...
enum class Gray4QuantizationMode : uint8_t { Legacy, Native };

inline QuantizedGray4 quantizeGray4Legacy(int gray) {
  if (gray < 0) gray = 0;
...
inline QuantizedGray4 quantizeGray4Native(int gray) {
  if (gray < 0) gray = 0;
  if (gray > 255) gray = 255;

  // Midpoints between the BMP/display palette levels 0, 85, 170, and 255.
...
inline QuantizedGray4 quantizeGray4(int gray, const Gray4QuantizationMode mode) {
  return mode == Gray4QuantizationMode::Legacy ? quantizeGray4Legacy(gray) : quantizeGray4Native(gray);
}
...
class AtkinsonDitherer {
 public:
  explicit AtkinsonDitherer(int width, Gray4QuantizationMode quantizationMode = Gray4QuantizationMode::Native)
...
class FloydSteinbergDitherer {
 public:
  explicit FloydSteinbergDitherer(int width, Gray4QuantizationMode quantizationMode = Gray4QuantizationMode::Native)
