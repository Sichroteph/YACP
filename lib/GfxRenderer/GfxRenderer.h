...
class GfxRenderer {
 ...
 public:
  ...
  void drawIconLightGray(const uint8_t bitmap[], int x, int y, int size) const;
  void drawIconLightGray(const uint8_t bitmap[], int x, int y, int width, int height) const;
